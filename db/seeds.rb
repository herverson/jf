...
r = Restaurant.create!(
  ...
  state: 'CE', city: 'Ceará', street: 'Melo Barreto',
...
r = Restaurant.create!(
  ...
  status: 'open', delivery_tax: 5.50,
  state: 'CE', city: 'Ceará', street: 'Viela Eugênio Monteiro Junior',
...
r = Restaurant.create!(
  ...
  state: 'CE', city: 'Ceará', street: 'Rua Coperema',
...
r = Restaurant.create!(
  ...
  state: 'CE', city: 'Ceará', street: 'Rua Joaquim Pinto',
...
r = Restaurant.create!(
  ...
  state: 'CE', city: 'Ceará', street: 'Avenida Manoel Domingos Pinto',
...
r = Restaurant.create!(
  ...
  state: 'CE', city: 'Ceará', street: 'Rua Francisco Artassio',
...
r = Restaurant.create!(
  ...
  state: 'CE', city: 'Ceará', street: 'Alameda dos Uapês',
...
r = Restaurant.create!(
  ...
  status: 'open', delivery_tax: 8.30,
  state: 'CE', city: 'Ceará', street: 'Rua Natal',
