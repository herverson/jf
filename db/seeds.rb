...
r = Restaurant.create!(
    ...
    estado: 'CE', cidade: 'Ceará', rua: 'Melo Barreto',
...
r = Restaurant.create!(
    ...
    status: 'open', delivery_tax: 5.50,
    estado: 'CE', cidade: 'Ceará', rua: 'Viela Eugênio Monteiro Junior',
...
r = Restaurant.create!(
    ...
    estado: 'CE', cidade: 'Ceará', rua: 'Rua Coperema',
...
r = Restaurant.create!(
    ...
    estado: 'CE', cidade: 'Ceará', rua: 'Rua Joaquim Pinto',
...
r = Restaurant.create!(
    ...
    estado: 'CE', cidade: 'Ceará', rua: 'Avenida Manoel Domingos Pinto',
...
r = Restaurant.create!(
    nome: 'Okuyamah',
    descricao: 'Restaurante conceituado, vencedor por 5 vezes como melhor restaurante Japones de Ceará.',
    status: 'open', delivery_tax: 8.30,
    estado: 'CE', cidade: 'Ceará', rua: 'Rua Francisco Artassio',
...
r = Restaurant.create!(
    ...
    estado: 'CE', cidade: 'Ceará', rua: 'Alameda dos Uapês',
...
r = Restaurant.create!(
    ...
    status: 'open', delivery_tax: 8.30,
    estado: 'CE', cidade: 'Ceará', rua: 'Rua Natal',
